...
import colour_demosaicing as colour_demosaicing
import tifffile
...
class ProcessImage:
    ...
    def folder_choice(initialpath="/Volumes/KINGSTON/"):
        ...
        :param initialpath: Initial path of the dialog box.
    ...
    @staticmethod
    def demosaic_algorithm(CFA, pattern="BGGR", algorithm="bilinear"):
        """
        .... This computation is slow.
        :param CFA: Image array mosaic
        :param pattern: Bayer pattern
        :param algorithm: Demosaic algorithm (bilinear, Malvar2004, Menon2007)
        :return:
        """
        if algorithm == "bilinear":
            rgb = colour_demosaicing.demosaicing_CFA_Bayer_bilinear(CFA, pattern)
        elif algorithm == "Malvar2004":
            rgb = colour_demosaicing.demosaicing_CFA_Bayer_Malvar2004(CFA, pattern)
        elif algorithm == "Menon2007":
            rgb = colour_demosaicing.demosaicing_CFA_Bayer_Menon2007(CFA, pattern)
        else:
            raise ValueError("Not a valid demosaicing algorithm.")
        return rgb
